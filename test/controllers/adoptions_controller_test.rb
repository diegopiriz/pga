...
class AdoptionsControllerTest < ActionController::TestCase
  ...
  test "should create adoption" do
    assert_difference('Adoption.count') do
      post :create, adoption: { adopter_id: @adoption.adopter_id, date: @adoption.date, dog_id: @adoption.dog_id }
    end
  ...
  test "should update adoption" do
    patch :update, id: @adoption, adoption: { adopter_id: @adoption.adopter_id, date: @adoption.date, dog_id: @adoption.dog_id }
    assert_redirected_to adoption_path(assigns(:adoption))
  end
